...
![[Pasted image 20250218193704.png]]

- 安装第三方软件（PMS中没有的）
- 假设安装github上的一个项目thefuck
	1. 查看项目的readme
	2. 要添加一下三个依赖（Unbuntu自带python，在`/usr/bin`中查看）![[Pasted image 20250218202815.png|300]]
	3. 安装依赖及软件，可以使用pip镜像源安装更快![[Pasted image 20250218202903.png]]
	4. 基于debian的系统可能不支持pip![[Pasted image 20250218203229.png]]
	5. 解决方案：1.使用系统包管理器安装；2.创建python虚拟环境，这里使用第二种（[参考](https://blog.csdn.net/iblade/article/details/135002063)）![[Pasted image 20250218204008.png]]
	6. 好吧还是不行...