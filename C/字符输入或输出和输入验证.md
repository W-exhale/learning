...
![[IMG_20240118_085757_edit_428414011984175.jpg|600]]
缓冲：
...
1. 在文件末尾放一个特殊的字符标记文件结尾。
	...
	![[IMG_20240118_105552_edit_435461148718570.jpg]]
2. 存储文件大小的信息
...
4. 使用该程序进行键盘输入，不能只输入字符EOF，也不能只输入-1（这是两个字符）。再UNIX和Linux系统中，在一行开始处按下ctrl+D会传输文件结尾信号，许多微型计算机系统都把一行开始处的ctrl+Z识别为文件结尾信号，一些系统把任意位置的ctrl+Z解释成文件结尾信号。
 ![[IMG_20240118_113110_edit_437585309491302.jpg|600]]
 windows ctrl+z结束
 每次按下enter键处理一次
##### 模拟EOF和图形界面
...
- 命令与重定向运算符的顺序无关
![[IMG_20240118_134324_edit_443759766526915.jpg]]
...
小结：
![[IMG_20240118_141515_edit_445682263720244.jpg]]![[IMG_20240118_141530_edit_445694593555292.jpg]]
